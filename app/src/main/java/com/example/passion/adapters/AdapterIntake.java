...
public class AdapterIntake extends RecyclerView.Adapter<AdapterIntake.MyHolder> {
    ...
    public AdapterIntake(Context context, List<ModelComments> commentsList, String myUid, String postId) {
